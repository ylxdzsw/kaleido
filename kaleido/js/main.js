...
(function() {
  var COLORS, Monitors, addMonitor, alertMessage, getRandomColor, kaleido, loadAllMonitors, renderAllMonitors, renderMonitor, saveAllMonitors, syncAllMonitors, syncMonitor, updateAllRenderedMonitors, updateRenderedMonitor;
  ...
  kaleido.alert = alertMessage = function(msg, type) {
    var HTMLstr;
    if (type == null) {
      type = "info";
    }
